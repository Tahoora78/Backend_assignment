...
app.config['SECRET_KEY'] = 'huhibobo16531ouhbo57uygu'
# database name
...
app.config['MAIL_USERNAME'] = 'tahuoramajlesi@gmail.com'
app.config['MAIL_PASSWORD'] = 'kvkyrcjsiafexnuh'
